/****************************************************************************
** Meta object code from reading C++ file 'img_label.h'
**
...
#error "The header file 'img_label.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 18, 9) // "ImgLabel*"

    },
    "ImgLabel\0clicked\0\0ImgLabel*"
};
...
void ImgLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< ImgLabel*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ImgLabel::*)(ImgLabel * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImgLabel::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImgLabel::clicked(ImgLabel * _t1)
{
