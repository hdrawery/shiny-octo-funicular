/****************************************************************************
** Meta object code from reading C++ file 'video_list_widget.h'
**
...
#error "The header file 'video_list_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 16, 12), // "findPrevious"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "findNext"
QT_MOC_LITERAL(4, 39, 12), // "getListIndex"
QT_MOC_LITERAL(5, 52, 10), // "currentRow"
QT_MOC_LITERAL(6, 63, 14), // "toFindPrevious"
QT_MOC_LITERAL(7, 78, 10) // "toFindNext"

    },
    "VideoListWidget\0findPrevious\0\0findNext\0"
    "getListIndex\0currentRow\0toFindPrevious\0"
    "toFindNext"
};
...
void VideoListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->findPrevious(); break;
        case 1: _t->findNext(); break;
        case 2: _t->getListIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->toFindPrevious(); break;
        case 4: _t->toFindNext(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoListWidget::findPrevious)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (VideoListWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoListWidget::findNext)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void VideoListWidget::findPrevious()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void VideoListWidget::findNext()
{
